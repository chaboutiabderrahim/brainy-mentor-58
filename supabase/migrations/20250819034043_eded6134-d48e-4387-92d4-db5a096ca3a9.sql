-- Create subscription plans and user subscription tables (fixed)
...
INSERT INTO public.subscription_plans (plan_code, name, price_dzd, features) VALUES
('FREE', 'Free Plan', 0, '{
  "subjects_allowed": 0,
  "video_access": true,
