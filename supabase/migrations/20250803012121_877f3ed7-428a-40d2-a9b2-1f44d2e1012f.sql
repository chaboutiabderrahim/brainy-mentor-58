...
-- Create profiles for example users with proper UUID casting
INSERT INTO public.profiles (user_id, display_name, role, stream_id)
SELECT '11111111-1111-1111-1111-111111111111'::uuid, 'Ahmed Ali', 'regular_student', s.id
FROM public.streams s WHERE s.code = 'SM'
UNION ALL
SELECT '22222222-2222-2222-2222-222222222222'::uuid, 'Sara Mohamed', 'previous_student', s.id
FROM public.streams s WHERE s.code = 'SM'
